...
PROMPT = """이 영수증 이미지를 분석해서 다음 JSON을 반환하세요. 한국어/영어 영수증을 모두 지원합니다. JSON만 반환하고 다른 텍스트는 없어야 합니다.
...
- 영어 영수증은 total, amount paid, balance due, grand total, subtotal+tax 중 최종 결제 금액을 우선합니다.
- 달러/외화 표기는 숫자만 반환하고, category/description은 앱에서 쓸 수 있게 간결하게 반환합니다.
